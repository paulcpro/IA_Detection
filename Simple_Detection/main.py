...
# model = YOLO("./models/yolov8n.pt")  # Utilise un modèle léger pour meilleures performances
model = YOLO("./models/yolov8s.pt")  # Utilise un modèle léger pour meilleures performances
# model = YOLO("./models/yolov8m.pt")  # Utilise un modèle léger pour meilleures performances
...
with mss.mss() as sct:
    prev_time = 0  # Pour calculer les FPS
    ...
    while True:
        ...
        for result in results:
            ...
            for box in result.boxes:
                ...
                # Dessiner un rectangle et le label autour de l'objet détecté
        ...
        cv2.imshow("YOLO Game Analysis", img)
