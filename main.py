...
# model = YOLO("yolov8n.pt")  # Utilise un modèle léger pour meilleures performances
model = YOLO("yolov8s.pt")  # Utilise un modèle léger pour meilleures performances
# model = YOLO("yolov8m.pt")  # Utilise un modèle léger pour meilleures performances
